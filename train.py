...
# from mineclip import get_args, set_seed, get_logger, save_state_dict, compute_metrices
from mineclip.mineclip.optimizer import get_optimizer
from mineclip.utils.metrices import compute_metrices
from mineclip.utils import set_seed
from mineclip.utils.logger import get_logger
from mineclip.utils.arg_parser import get_args
from mineclip.utils.torch_utils import save_state_dict
...
def main(args):
    ...
    for epoch in range(args.epochs):
        print("------The {} round started--------------".format(epoch+1))
        ...
        print("------The {} round finished--------------".format(epoch+1))
